---
title: 'GEOG 5670 6670 Lab 00: Accessing the CHPC/Introduction to Linux'
author: | 
  | Simon Brewer
...
In the QGIS interface, go to the [Layer] menu at the top, then [Add Layer] -> [Add Raster Layer]. In the next window, click the three dots [...] to open a browser, and navigate to the `forestry` folder. Click on the file *basic_map.tif* to import it. From here, try out the 
